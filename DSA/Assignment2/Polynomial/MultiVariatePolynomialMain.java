...
/**
 * MultiVariatePolynomialMain - visualise the representation of a multivariate
 * polynomial using a nested list
 * 
...
public class MultiVariatePolynomialMain {
	...
	public static void main(String args[]) {
		...
		for (int i = 0; i < numberOfVariables; i++) {
			System.out.println("Enter the number of coefficients for the "
					+ (i + 1) + " variable:");
			int numberOfCoefficient = scanner.nextInt();
			System.out.println("Enter the coefficients for the " + (i + 1)
					+ " variable:");
