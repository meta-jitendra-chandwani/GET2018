...
public class TriangleProxy implements areas.Triangle {
  private String _endpoint = null;
  private areas.Triangle triangle = null;
  ...
  private void _initTriangleProxy() {
    try {
      triangle = (new areas.TriangleServiceLocator()).getTriangle();
      if (triangle != null) {
        if (_endpoint != null)
  ...
  public areas.Triangle getTriangle() {
    if (triangle == null)
      _initTriangleProxy();
    return triangle;
  }
