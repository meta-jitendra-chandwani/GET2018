...
public class Utility {
	    ...
	    void displayItem() throws Exception { //display the item in cart
	    ...
	    void changeQuantity() throws Exception { //to  change the quantity of particular item
	    ...
	    void display() throws Exception{
	    	...
	    	productList.add(Product.setProduct());
	    }
}
