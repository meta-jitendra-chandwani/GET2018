...
import com.restProject.dao.connection.Connect;
import com.restProject.dao.Query.AdvertisementQueries;
...
public class MySQLAdvertismentDao implements AdvertismentDao {
	...
	public List<Advertisment> getAll() {
		...
		String query = AdvertisementQueries.SELECT_ALL_CATEGORY;
	...
	public boolean update(Advertisment t) {
		String query = AdvertisementQueries.UPDATE_QUERY;
	...
	public boolean create(Advertisment t) {
		String query = AdvertisementQueries.INSERT_QUERY;
	...
	public boolean deleteAdvertisment(int id) {
		String query = AdvertisementQueries.DELETE_QUERY;
		boolean isUpdatedFlag = false;
