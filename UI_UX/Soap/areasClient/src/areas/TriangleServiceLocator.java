...
public class TriangleServiceLocator extends org.apache.axis.client.Service implements areas.TriangleService {
    ...
    private java.lang.String Triangle_address = "http://localhost:8080/areas/services/Triangle";
    ...
    public areas.Triangle getTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            areas.TriangleSoapBindingStub _stub = new areas.TriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (areas.Triangle.class.isAssignableFrom(serviceEndpointInterface)) {
                areas.TriangleSoapBindingStub _stub = new areas.TriangleSoapBindingStub(new java.net.URL(Triangle_address), this);
                _stub.setPortName(getTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://areas", "TriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://areas", "Triangle"));
        }
