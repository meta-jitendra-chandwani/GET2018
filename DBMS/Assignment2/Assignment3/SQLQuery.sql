...
SELECT P.Product_Title FROM Order_Product AS OP INNER JOIN Product AS P INNER JOIN Orders as O ON OP.Product_Id=P.Product_Id && OP.Order_Id=O.Order_Id WHERE O.Status="Shipped"  && O.Order_Id like "Order08%";
